...
> ### NestJS app prototype to test nestjs CI/CD.
...
Create a new mysql database with the name `example name`\
...
Start local mysql server and create new database 'db_name'
...
Create a new mysql database with the name `db_name_prisma` (or the name you specified in `prisma/.env`)
